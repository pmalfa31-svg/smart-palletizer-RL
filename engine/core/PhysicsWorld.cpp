...
PhysicsWorld::~PhysicsWorld() {
    ...
    delete groundShape;
    // world/solver/broadphase/dispatcher/collisionConfig: unique_ptr, auto-cleanup
    // (l'ordine di distruzione dei membri e' gia' quello corretto: world
    // prima di dispatcher/broadphase/collisionConfig, come richiesto da Bullet)
}
